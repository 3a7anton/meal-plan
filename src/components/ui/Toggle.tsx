    ...
    return (
      <label className={cn('flex items-center cursor-pointer', className)}>
        <div className="relative">
          ...
          />
          <div className={cn(
            "w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-primary-300",
            ...
            "peer-checked:bg-primary-600 peer-checked:after:border-transparent"
          )}></div>
        </div>
        {(label || description) && (
          <div className="ml-3">
